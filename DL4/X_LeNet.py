...
# 封装的MNIST预测器
class LeNet():
    def __init__(self, iterations=10000, lr=0.005, batch_size=64, mu=0, sigma=0.1):
        # self.sess       = sess 
        # 定义超参数
    ...
    def _build_network_graph(self, network_name):
        # 调用网络
        self.y = self.LeNet(self.input_x, network_name)
        tf.summary.histogram("predicted_y", self.y)
    ...
    def _compute_loss_graph(self):
        ...
        with tf.name_scope("loss_function"):
            ...
            tf.summary.histogram("loss", self.cross_entropy)
